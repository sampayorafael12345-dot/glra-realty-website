  ...
  ready(function(){
    ...
    if(nav){
      ...
      links.innerHTML = ''
        ...
        + '<a href="/arthaland.html">Arthaland</a>'
        ...
        +     '<a href="/bir-deadlines.html">// BIR Deadlines</a>'
        +     '<a href="/property-tax.html">// Amilyar</a>'
        +     '<a href="/pre-selling.html">// Pre-Selling Schedule</a>'
        +     '<a href="/pagibig-loanable.html">// Pag-IBIG Loanable</a>'
        +     '<a href="/vat-exemption.html">// VAT Exemption</a>'
        +     '<a href="/rental-income-tax.html">// Rental Income Tax</a>'
        +     '<a href="/lease-escalation.html">// Lease Escalation</a>'
        +     '<a href="/principal-residence.html">// Principal Residence</a>'
        +     '<a href="/amortization.html">// Amortization &amp; Pag-IBIG vs Bank</a>'
    ...
    if(overlay){
      overlay.innerHTML = ''
        ...
        + '<a href="/arthaland.html" onclick="closeMobileMenu()">Arthaland</a>'
        ...
        + '<a href="/amortization.html" onclick="closeMobileMenu()">Amortization &amp; Pag-IBIG vs Bank</a>'
